...
export class AddPhonetoCart{
    constructor(page){
        ...
        this.item=page.locator("//a[text()='Phones']")
        this.phone=page.locator("//a[text()='Iphone 6 32gb']")
        this.addproduct=page.locator("//a[@onclick='addToCart(5)']")
