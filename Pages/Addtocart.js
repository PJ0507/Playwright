...
export class Addtocart{
    constructor(page){
        ...
        this.item=page.locator("//a[text()='Laptops']")
        this.macboonpro=page.locator("//a[text()='MacBook Pro']")
        this.addproduct=page.locator("//a[@onclick='addToCart(15)']")
